...
generator.load_state_dict(torch.load('/media/arg_ws3/5E703E3A703E18EB/research/pix2pix_seg/saved_models/pix2pix_seg_dep_norm/generator_70.pth'))
...
def sample_images():
    ...
    save_image(my_img_fake.data, 'mask_pil2.png', nrow=1, normalize=False)
